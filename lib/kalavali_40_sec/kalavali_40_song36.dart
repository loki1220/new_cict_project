...
class kalavaliSongThirtysix extends StatefulWidget {
  const kalavaliSongThirtysix({Key? key}) : super(key: key);

  @override
  State<kalavaliSongThirtysix> createState() => _kalavaliSongThirtysixState();
}

class _kalavaliSongThirtysixState extends State<kalavaliSongThirtysix> {
  @override

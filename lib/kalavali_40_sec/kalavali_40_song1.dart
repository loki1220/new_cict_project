...
class kalavaliSongOne extends StatefulWidget {
  const kalavaliSongOne({Key? key}) : super(key: key);

  @override
  State<kalavaliSongOne> createState() => _kalavaliSongOneState();
}

class _kalavaliSongOneState extends State<kalavaliSongOne> {
  @override
